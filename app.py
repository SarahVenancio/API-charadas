...
charadas = [
    {'id': 1, 'pergunta': 'A Dora é mestre em artes marciais. Sabe qual é o seu golpe preferido?', 'resposta': 'A voa-Dora'},
    ...
    {'id': 7, 'pergunta': 'Onde os minions moram?', 'resposta': 'Em condo-minions'},
